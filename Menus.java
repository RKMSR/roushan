...
public class Menus {
	...
	public void introScreen() {
		System.out.println();
		System.out.println("*************************************************");
		System.out.println("*      DEVELOPED BY ROUSHAN KUMAR               *");
		System.out.println("*************************************************");
	...
	public void subMenu() {
		...
		do {
			...
			case 1: 
					...
					fileName = file.trim();
					try {
						dao.createNewFile(test.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IOException e) {
			...
			case 2: 
					...
					fileName = file.trim();
					try {
						dao.deleteFile(test.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IOException e) {
			...
			case 3: 
					...
					fileName = file.trim();
					try {
						dao.searchFile(test.path, fileName);
					}catch(NullPointerException e) {
						System.out.println(e.getMessage());
					}catch(IllegalArgumentException e) {
						System.out.println(e.getMessage());
